...
<div id="ag-modal" style="position:fixed;inset:0;z-index:2147483000;" class="fixed inset-0 z-[9999] bg-allgood-dark/95 flex items-center justify-center p-6 hidden-modal modal-transition backdrop-blur-sm">
    <div class="bg-white rounded-lg shadow-2xl p-8 max-w-sm w-full text-center border-t-4 border-allgood-primary relative">
        ...
        <div id="ag-returning" class="hidden">
            ...
            <p class="text-gray-500 text-xs mb-5 font-body leading-relaxed">Sign in with Google if you have an account, or use your passphrase if you're a Learner Recruit.</p>
            <p id="ag-returning-error" class="text-red-500 text-xs mb-2 hidden font-body"></p>

            <button id="ag-btn-returning-google" class="w-full p-3 rounded shadow-md hover:shadow-lg transition-all duration-200 bg-white border border-gray-300 flex items-center justify-center gap-3 font-bold text-sm text-allgood-dark uppercase mb-4">
            ...
            <button id="ag-btn-returning-passphrase" class="w-full bg-white border-2 border-allgood-secondary text-allgood-secondary hover:bg-allgood-secondary hover:text-white font-bold py-3 rounded shadow-sm transition-all font-body uppercase mb-4">
                I have a passphrase
            </button>

            <button id="ag-btn-returning-email" class="text-xs text-gray-400 hover:text-allgood-primary underline decoration-dotted font-body block mx-auto mb-2">Used an email and password instead?</button>
